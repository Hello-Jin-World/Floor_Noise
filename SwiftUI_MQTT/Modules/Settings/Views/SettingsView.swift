...
struct SettingsView: View {
    ...
    var body: some View {
        VStack {
            ...
            MQTTTextField(placeHolderMessage: "Broker Address를 입력하세요.", isDisabled: mqttManager.currentAppState.appConnectionState != .disconnected, message: $brokerAddress)
        ...
        .navigationTitle("Broker Host 지정")
